...
%                     convn(cnn.dEdB{l+1}(:,:,nm), cnn.W{l+1}(:,:,pm, nm), 'full');
%                     convn(cnn.dEdB{l+1}(end:-1:1,end:-1:1,nm), cnn.W{l+1}(end:-1:1,end:-1:1,pm, nm), 'full');
%                     convn(cnn.dEdB{l+1}(end:-1:1,end:-1:1,nm), cnn.W{l+1}(:,:,pm, nm), 'full');
            end
        end
